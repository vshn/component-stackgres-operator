...
kubectl -n "$NAMESPACE" delete --ignore-not-found=true certs stackgres-operator-cert stackgres-operator-ca
kubectl -n "$NAMESPACE" delete --ignore-not-found=true secrets stackgres-operator-certs stackgres-operator-ca
